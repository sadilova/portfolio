library(ggplot2)
library(nortest)
library(car)  # For checking multicollinearity in multiple regression
...
## Normality of residuals using Anderson-Darling test
residuals_mod <- residuals(mod)
ad_test_result <- ad.test(residuals_mod)
print(ad_test_result)  # Print test result

## Normality check visualizations

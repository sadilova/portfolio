function AS1_NIFTI_NORDIC(extDIR, SUB, RUN_LABEL, fn_magn_in, fn_phase_in, fn_out, ARG)
    if nargin < 7
        ...
        DIR         = [extDIR, 'derivatives/', SUB, '/preproc/NORDIC/'];
        % Include RUN_LABEL in filename if provided
        ...
        fn_out      = ['NORDIC_', base_name];   % e.g. NORDIC_Run_BOLD_sub01_cap1_run1
        ARG         = struct();
